...
export const ModelSelectorLogo = ({ provider, className }: ModelSelectorLogoProps) => (
  // Using native img instead of Next.js Image for extension compatibility
  // biome-ignore lint/performance/noImgElement: external URL for provider logos
  <img
    alt={`${provider} logo`}
