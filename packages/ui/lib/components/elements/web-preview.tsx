...
export const WebPreview = ({
  ...
  return (
    <WebPreviewContext.Provider
      value={{ url, setUrl: handleUrlChange, consoleOpen, setConsoleOpen }}>
      <div
...
export const WebPreviewNavigation = ({ className, children, ...props }: ComponentProps<'div'>) => (
  <div className={cn('flex items-center gap-1 border-b p-2', className)} {...props}>
    {children}
  </div>
);

export type WebPreviewNavigationButtonProps = ComponentProps<typeof Button> & { tooltip?: string };
  ...
  <TooltipProvider>
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          className="hover:text-foreground size-8 p-0"
          disabled={disabled}
          onClick={onClick}
          size="sm"
          variant="ghost"
